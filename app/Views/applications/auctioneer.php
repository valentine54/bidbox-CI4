...
<head>
    ...
    <title>Auctioneer Application</title>
...
<div class="content">
    <div class="guidelines">
        <h1>Becoming an Auctioneer </h1>
        <p>Minimum guidelines for being an auctioneer in our system:</p>
        <ul>
            <li>Must have experience as an auctioneer before</li>
            <li>Must have adequate knowledge in the luxury industry</li>
            <li>Must be 18yrs and older</li>
            <li>Must be indifferent</li>
        </ul>
        ...
        <ul>
            ...
            <li>Copy of your curriculum vitae</li>
    ...
    <div class="form-container">
        ...
        <form action="<?= site_url('application/submit') ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="type" value="auctioneer">
